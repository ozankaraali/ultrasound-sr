...
from models.residual_attention_network import ResidualAttentionModel56 as ResidualAttentionModel
...
class FPN(nn.Module):
    ...
    def __init__(self, norm_layer, num_filters=256):
        ...
        self.resnet = ResidualAttentionModel()
        # self.resnet.load_state_dict(torch.load('models/residual_attention_network.pkl'))
        ...
        self.enc1 = nn.Sequential(
            self.resnet.mpool1,
            self.resnet.residual_block1,
            self.resnet.attention_module1
        )  # 128
        self.enc2 = nn.Sequential(
            self.resnet.residual_block2,
            self.resnet.attention_module2,
        )  # 256
        self.enc3 = nn.Sequential(
            self.resnet.residual_block3,
            self.resnet.attention_module3,
        )  # 512
        self.enc4 = nn.Sequential(
            self.resnet.residual_block4,
            self.resnet.residual_block5,
            self.resnet.residual_block6,
        )  # 1024
