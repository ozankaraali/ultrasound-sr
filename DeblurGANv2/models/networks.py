...
# from models.fpn_attention import FPNAttention
from models.fpn_swin import FPNSwin
###############################################################################
# Functions
###############################################################################
...
def get_generator(model_config):
    ...
    # elif generator_name == 'fpn_attention':
    #     model_g = FPNAttention(norm_layer=get_norm_layer(norm_type=model_config['norm_layer']))
    elif generator_name == 'fpn_swin':
        model_g = FPNSwin(norm_layer=get_norm_layer(norm_type=model_config['norm_layer']))
    else:
